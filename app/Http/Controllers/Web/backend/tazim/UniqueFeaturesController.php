...
class UniqueFeaturesController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            Log::error('UniqueFeatures store failed: ' . $e->getMessage(), [
    ...
    public function storeHeader(Request $request)
    {
        try {
            ...
            Log::error('storeHeader failed in WhatMakesUsDiffHead: ' . $e->getMessage(), [
                'trace' => $e->getTraceAsString(),
                'input' => $request->all(),
            ]);
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            Log::error('UniqueFeatures update failed: ' . $e->getMessage(), [
                'trace' => $e->getTraceAsString(),
                'id'    => $id,
                'input' => $request->all(),
            ]);

            return redirect()->back()->with('error', 'Something went wrong while updating the feature.')->withInput();
        }
    }
