...
@section('title', 'About Page Banner Create')
    ...
    <div class="app-content content">
        <div class="row">
            <div class="col-lg-6 m-auto">
                <form action="{{ route('exploreNatTrvlWitBan.store') }}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="card card-body">
                        <h4 class="mb-4"> <span id="Categorytitle">About Page Banner Create</span></h4>
                        {{-- <h4 class="mb-4"> <span id="Categorytitle">Explore Nature Travel with Banner Create</span></h4> --}}
