...
@endpush
@section('title', 'Travel Advisor List')
@section('content')
    <div class="app-content content ">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Travel Advisor List</h3>
                <a href="{{ route('travelAdvisor.create') }}" class="btn btn-primary btn-sm">Add New</a>
            </div>
            <div class="card-body">
            ...
            $(document).ready(function() {
                if (!$.fn.DataTable.isDataTable('#data-table')) {
                    $('#data-table').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('travelAdvisor.getData') }}",
                        columns: [{
                                data: 'name',
                                name: 'name'
                            },
