...
@section('title', 'Nature Explore Fin Wilderness Banner Create')
    ...
    <div class="app-content content">
        <div class="row">
            <div class="col-lg-6 m-auto">
                <form action="{{ route('ntrTripExpFinWitBan.store') }}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="card card-body">
                        <h4 class="mb-4"> <span id="Categorytitle">Nature Trip - Explore Finnish Wilderness Banner
                                Create</span></h4>
