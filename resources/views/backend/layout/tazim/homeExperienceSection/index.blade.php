    ...
    <div class="app-content content ">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('homeExperienceImageSection.create') }}" class="btn btn-primary btn-sm">Add New</a>
            </div>
            <div class="card-body">
                <div class="table-responsive mt-4 p-4 card-datatable table-responsive pt-0">
                    <table class="table table-hover" id="data-table">
                        <thead>
                            <tr>
                                <th style="width: 20%">Image Serial</th>
                                <th class="text-center" style="width: 70%">Image</th>
                ...
                $(document).ready(function() {
                    if (!$.fn.DataTable.isDataTable('#data-table')) {
                        $('#data-table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: "{{ route('homeExperienceImageSection.getData') }}",
                            columns: [{
                                    data: 'name',
                                    name: 'name'
                                },
