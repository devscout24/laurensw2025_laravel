    ...
    <div class="app-content content ">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Snippet Edit</h3>
                <div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('snippet.update', $data->id) }}" method="POST" class="tm-form"
                    ...
                    <div class="form-field-wrapper">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                required placeholder="Enter Snippet Title"
                    ...
                    <div class="form-field-wrapper">
                        <div class="form-group">
                            ...
                            <textarea name="snippet_content" class="form-control @error('snippet_content') is-invalid @enderror"
                                id="snippet_content">{{ old('snippet_content') ?? ($data->snippet_content ?? '') }}</textarea>
