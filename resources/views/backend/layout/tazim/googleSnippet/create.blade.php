    ...
    <div class="app-content content ">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Snippet Create</h3>
                <div>
                    <a href="{{ route('snippet.index') }}" class="btn btn-primary" type="button">
            ...
            <div class="card-body">
                <form class="form" method="POST" action="{{ route('snippet.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-field-wrapper">
                        <div class="form-group">
                            <label for="title">Snippet Title</label>
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                required placeholder="Snippet Title" value="{{ old('title') }}">
                            @error('title')
                    ...
                    <div class="form-field-wrapper">
                        <div class="form-group">
                            <label for="snippet_content">Snippet Code</label>
                            <textarea name="snippet_content" class="form-control @error('snippet_content') is-invalid @enderror"
                                id="snippet_content">{{ old('snippet_content') }}</textarea>
                            @error('snippet_content')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
