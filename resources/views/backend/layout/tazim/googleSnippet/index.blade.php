                    ...
                    <table class="table table-hover" id="data-table">
                        <thead>
                            <tr>
                                ...
                                <th class="width=30%">Snippet Title</th>
                                <th class="width=50%">Snippet Code</th>
    ...
    @push('script')
        ...
        <script>
            ...
            function deleteFinal(id) {
                let deleteUrl = '{{ route('snippet.destroy', ':id') }}'.replace(':id', id);
                fetch(deleteUrl, {
                        method: 'DELETE',
                        headers: {
            ...
            function changeStatus(event, id) {
                ...
                let statusUrl = '{{ route('snippet.status', ':id') }}'.replace(':id', id);

                Swal.fire({
                    title: 'Are you sure?',
                    text: "You want to change the status of this snippet.",
                    icon: 'warning',
                    showCancelButton: true,
            ...
            function multi_delete() {
                ...
                if (ids.length == 0) {
                    ...
                    let url = "{{ route('snippet.bulk-delete') }}";
