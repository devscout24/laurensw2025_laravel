...
@section('content')
    <div class="app-content content ">
        <div class="row">
                ...
                <div class="col-lg-7">
                    <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">@csrf
                        <div class="card card-body">
                            <h4 class="mb-4"> <span id="Categorytitle">Create Gallery Images</span></h4>
                            <div class="row mb-2">
            ...
            @endif
            <div class="col-lg-5">
                <form action="{{ route('gallery.storeHeader') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card card-body">
                        <h4 class="mb-4"><span id="Categorytitle">Create Header</span></h4>
