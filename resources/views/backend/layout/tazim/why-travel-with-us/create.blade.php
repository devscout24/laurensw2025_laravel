...
@section('content')
    ...
    <div class="app-content content">
        <div class="row">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" name="description1" class="form-control"
                                        placeholder="Description..." value="{{ old('description1') }}" cols="30"
                                        rows="10">
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" name="description2" class="form-control"
                                        placeholder="Description..." value="{{ old('description2') }}" cols="30"
                                        rows="10">
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" name="description3" class="form-control"
                                        placeholder="Description..." value="{{ old('description3') }}" cols="30"
                                        rows="10">
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-9">
                                    <input type="text" name="description4" class="form-control"
                                        placeholder="Description..." value="{{ old('description4') }}" cols="30"
                                        rows="10">
                                </div>
                            </div>
            ...
            <div class="col-lg-5">
                <form action="{{ route('popularNatureTourheader.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card card-body">
