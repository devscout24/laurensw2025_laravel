...
@section('content')
    <div class="app-content content ">
        <div class="row">
            <div class="col-lg-7">
                <form action="{{ route('responsibleTravel.store') }}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="card card-body">
                        <h4 class="mb-4"><span id="Categorytitle">Create Responsible Travel Content</span></h4>
            ...
            <div class="col-lg-5">
                <form action="{{ route('responsibleTravel.storeHeader') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card card-body">
