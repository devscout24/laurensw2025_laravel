    ...
    <div class="app-content content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Ships Lists</h3>
                <div style="display: flex; align-items: center;">
                    <a href="{{ route('booking.cruise.index') }}" class="btn btn-primary btn-sm mr-2">Ships Booking</a>
                    <a href="{{ route('cruise.import') }}" class="btn btn-success btn-sm mr-2">Import Ships</a>
                </div>
            </div>
            <div class="card-body">
