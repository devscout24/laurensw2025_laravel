                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo d-flex align-items-center justify-content-center">
                                    <img width="80" src="{{ asset($setting->logo??'backend/app-assets/images/logo/logo.png') }}" alt="logo">
                                    <h2 class="brand-text text-primary ml-1">{{ $setting->title??'Admin Panel' }}</h2>
                                </a>
